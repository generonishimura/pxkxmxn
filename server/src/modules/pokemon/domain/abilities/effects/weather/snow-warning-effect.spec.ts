import { SnowWarningEffect } from './snow-warning-effect';
...
describe('SnowWarningEffect', () => {
  ...
  describe('onEntry', () => {
    it('should change weather to Hail when onEntry is called', async () => {
    ...
    it('should not change weather when already Hail', async () => {
      const contextWithHail: BattleContext = {
        ...battleContext,
        battle: new Battle(1, 1, 2, 1, 2, 1, Weather.Hail, null, BattleStatus.Active, null),
      };
      await effect.onEntry(pokemon, contextWithHail);
