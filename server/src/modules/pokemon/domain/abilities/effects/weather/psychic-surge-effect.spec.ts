...
describe('PsychicSurgeEffect', () => {
  ...
  describe('onEntry', () => {
    it('should change field to PsychicTerrain when onEntry is called', async () => {
    ...
    it('should not change field when already PsychicTerrain', async () => {
