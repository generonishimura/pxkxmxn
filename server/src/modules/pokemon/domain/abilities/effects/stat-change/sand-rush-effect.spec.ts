...
describe('SandRushEffect', () => {
  ...
  describe('modifySpeed', () => {
    it('should return doubled speed in Sandstorm weather', () => {
      const result = effect.modifySpeed(pokemon, 100, battleContext);
      expect(result).toBe(200); // 100 * 2.0 = 200
    });

    it('should return undefined for non-Sandstorm weather', () => {
