import { SwordsDanceEffect } from './swords-dance-effect';
...
describe('SwordsDanceEffect', () => {
  ...
  describe('onUse', () => {
    it('should increase own attack rank by 2', async () => {
      const effect = new SwordsDanceEffect();
