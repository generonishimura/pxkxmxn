import { DroughtEffect } from './drought-effect';
...
describe('DroughtEffect', () => {
  ...
  beforeEach(() => {
    ...
    mockBattleRepository = {
      update: jest.fn().mockResolvedValue(
        new Battle(1, 1, 2, 1, 2, 1, Weather.Sun, null, BattleStatus.Active, null),
      ),
      findById: jest.fn(),
      create: jest.fn(),
  ...
  describe('onEntry', () => {
    it('should change weather to Sun when onEntry is called', async () => {
    ...
    it('should not change weather when already Sun', async () => {
